...
@NamedQueries({
    ...
    , @NamedQuery(name = "ApplicantType.findByDescription", query = "SELECT a FROM ApplicantType a WHERE a.description = :description")})
public class ApplicantType implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        ApplicantType other = (ApplicantType) object;
    ...
    public String toString() {
        return "com.cms.commons.models.ApplicantType[ id=" + id + " ]";
    }
