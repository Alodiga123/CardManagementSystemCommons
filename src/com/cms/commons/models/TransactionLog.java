...
public class TransactionLog implements Serializable {
    ...
    @JoinColumn(name = "transactionsManagementHistoryId", referencedColumnName = "id")
    @ManyToOne(optional = false)
    private TransactionsManagementHistory transactionsManagementHistoryId;
    ...
    public TransactionsManagementHistory getTransactionsManagementHistoryId() {
        return transactionsManagementHistoryId;
    }

    public void setTransactionsManagementHistoryId(TransactionsManagementHistory transactionsManagementHistoryId) {
        this.transactionsManagementHistoryId = transactionsManagementHistoryId;
    }
    ...
    public String toString() {
        return "com.cms.commons.models.TransactionLog[ id=" + id + " ]";
    }
