...
import com.alodiga.cms.commons.exception.InvalidEjbReferenceException;
...
public class EJBServiceLocator {
    ...
    private Map<String, DistributionGenericEJB> cache;
    ...
    private EJBServiceLocator() {
        try {
            ...
            this.cache = Collections.synchronizedMap(new HashMap<String, DistributionGenericEJB>());
    ...
    public DistributionGenericEJB get(String jndiName, Logger logger) throws InvalidEjbReferenceException {
        DistributionGenericEJB ret = null;
        try {
            if (this.cache.containsKey(jndiName)) {
                ret = this.cache.get(jndiName);
    ...
    public DistributionGenericEJB get(String jndiName, String server, String port) {
        return get(jndiName);
    }

    public DistributionGenericEJB get(String jndiName, String server, String port, Logger logger) throws InvalidEjbReferenceException {
