...
public class LocalServicesResponseCodes {
    ...
    public static final String NAUTA_EXTERNAL_ID_USED = "55";
    public static final String NAUTA_EXTERNAL_REACHED_MAX_TRANSACTION_NUMBER = "56";
    public static final String NAUTA_TIME_OUT = "57";
    public static final String NAUTA_REJECTED = "58";
    public static final String NAUTA_REPEAT = "59";
    public static final String NAUTA_TRANSACTION_ALREADY_PAID = "60";
    public static final String NAUTA_TRANSACTION_AMOUNT_LIMIT = "61";
    public static final String NAUTA_ACCOUNT_NUMBER_INCORRECT = "62";
    public static final String NAUTA_INSUFFICIENT_RETAIL_BALANCE= "63";
    public static final String NAUTA_INSUFFICIENT_BALANCE= "64";
    ...
    static {
        ...
        codes.put(NAUTA_EXTERNAL_ID_USED, "External id already used.");
        codes.put(NAUTA_EXTERNAL_REACHED_MAX_TRANSACTION_NUMBER, "Recipient reached maximum transaction number");
        codes.put(NAUTA_TIME_OUT, "Transaction Timeout");
        codes.put(NAUTA_REJECTED, "Transaction Rejected.");
        codes.put(NAUTA_REPEAT, "Transaction repeated.");
        codes.put(NAUTA_TRANSACTION_ALREADY_PAID, "Transaction already paid");
        codes.put(NAUTA_TRANSACTION_AMOUNT_LIMIT, "Transaction amount limit exceeded.");
        codes.put(NAUTA_ACCOUNT_NUMBER_INCORRECT, "Account number incorrect.");
        codes.put(NAUTA_INSUFFICIENT_RETAIL_BALANCE, "Insufficient balance in your retailer account.");
        codes.put(NAUTA_INSUFFICIENT_BALANCE, "Insufficient balance in your master account");
    }
