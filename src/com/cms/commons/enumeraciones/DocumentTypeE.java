...
public enum DocumentTypeE {
    ...
    CARD_RECHARGE(14,"CARD RECHARGE","CARREC"),
    CARD_WITHDRAWL(15, "CARD WITHDRAWL", "CARWIT"),
    KEY_CHANGE(16, "KEY CHANGE", "KEYCHA"),
    CARD_PURCHAGE(17,"CARD PURCHAGE","CARPUR"),
    REVERSE_WITHDRAWAL(18, "REVERSE WITHDRAWAL", "REVWIT"),
    REVERSE_CARD_RECHARGE(19, "REVERSE CARD RECHARGE", "RECARE"),
    KEY_REGISTER(20, "KEY REGISTER", "KEYREG");
